...
#include "Bs2DsPi_lowmassbkg_updated.h"
#include <iostream>
#include "math.h"
#include "TMath.h"
...
PDF_CREATOR( Bs2DsPi_lowmassbkg_updated );
...
void Bs2DsPi_lowmassbkg_updated::MakePrototypes()
{
...
//Destructor
Bs2DsPi_lowmassbkg_updated::~Bs2DsPi_lowmassbkg_updated()
{
}
...
double Bs2DsPi_lowmassbkg_updated::Evaluate(DataPoint * measurement)
{
	// Observable
