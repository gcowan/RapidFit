// $Id: Bs2JpsiPhi_SignalAlt_MO_dev.cpp,v 1.1 2009/12/06 Pete Clarke Exp $
/** @class Bs2JpsiPhi_SignalAlt_MO_dev Bs2JpsiPhi_SignalAlt_MO_dev.cpp
 *
...
bool Bs2JpsiPhi_SignalAlt_MO_dev::SetPhysicsParameters( ParameterSet * NewParameterSet )
{
