// $Id: Bs2JpsiPhi_SignalAlt_MO_v3.cpp,v 1.1 2009/12/06 Pete Clarke Exp $
/** @class Bs2JpsiPhi_SignalAlt_MO_v3 Bs2JpsiPhi_SignalAlt_MO_v3.cpp
 *
...
{
	MakePrototypes();	
	std::cout << "Constructing PDF: Bs2JpsiPhi_SignalAlt_MO_v3 " << std::endl ;
}


//......................................
//Make the data point and parameter set
void Bs2JpsiPhi_SignalAlt_MO_v3::MakePrototypes()
{
...
//........................................................
//Destructor
Bs2JpsiPhi_SignalAlt_MO_v3::~Bs2JpsiPhi_SignalAlt_MO_v3() { }


//........................................................
//Set the physics parameters into member variables

bool Bs2JpsiPhi_SignalAlt_MO_v3::SetPhysicsParameters( ParameterSet * NewParameterSet )
{
	...
	if( (Azero_sq < 0.) || (Azero_sq > 1.)  ) { cout << "Warning in Bs2JpsiPhi_SignalAlt_MO_v3::SetPhysicsParameters: Azero_sq <0 or >1 but left as is" <<  endl ;	}	
	Aperp_sq = allParameters.GetPhysicsParameter( Aperp_sqName )->GetValue();
	if( (Aperp_sq < 0.) || (Aperp_sq > 1.)  ) { cout << "Warning in Bs2JpsiPhi_SignalAlt_MO_v3::SetPhysicsParameters: Aperp_sq <0 or >1 but left as is" <<  endl ;	}	
	...
	if( Apara_sq < 0. ) {
		cout << "Warning in Bs2JpsiPhi_SignalAlt_MO_v3::SetPhysicsParameters: derived parameter Apara_sq <0  and so set to zero" <<  endl ;
		Apara_sq = 0. ;
	}	
...
vector<string> Bs2JpsiPhi_SignalAlt_MO_v3::GetDoNotIntegrateList()
{
	vector<string> list;
...
double Bs2JpsiPhi_SignalAlt_MO_v3::EvaluateForNumericIntegral(DataPoint * measurement) 
{
...
double Bs2JpsiPhi_SignalAlt_MO_v3::Evaluate(DataPoint * measurement)
{
	...
	if( DEBUGFLAG && (c1 || c2 || c3)  ) {
		cout << endl ;
		cout << " Bs2JpsiPhi_SignalAlt_MO_v3::evaluate() returns <=0 or nan :" << returnValue << endl ;
...
double Bs2JpsiPhi_SignalAlt_MO_v3::EvaluateTimeOnly(DataPoint * measurement)
{
	// Get observables into member variables
	t = measurement->GetObservable( timeName )->GetValue() - timeOffset ;
	//ctheta_tr = measurement->GetObservable( cosThetaName )->GetValue();
...
double Bs2JpsiPhi_SignalAlt_MO_v3::Normalisation(DataPoint * measurement, PhaseSpaceBoundary * boundary)
{
	...
	if( DEBUGFLAG && (c1 || c2 ) ) {
		cout << endl ;
		cout << " Bs2JpsiPhi_SignalAlt_MO_v3::normalisation() returns <=0 or nan :" << returnValue << endl ;
		cout << "   gamma " << gamma() << endl ;
		cout << "   gl    " << gamma_l() << endl ;
		cout << "   gh    " << gamma_h()  << endl;
		cout << "   AT^2    " << AT()*AT() << endl;
