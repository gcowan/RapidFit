...
PDF_CREATOR( Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave );

//Constructor
Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave::Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave( PDFConfigurator* configurator ) : cachedAzeroAzeroIntB(),
...
cachedCosPhis(), cachedExpCosh(), cachedExpSinh(), cachedExpCos(), cachedExpSin(),
	...
	, gamma(), deltaGamma(), deltaMs(), Phi_s(), Azero_sq(),
	Apara_sq(), Aperp_sq(), As_sq(), AzeroApara(),
	AzeroAperp(), AparaAperp(), AsApara(), AsAperp(),
	AsAzero(), delta_zero(), delta_para(), delta_perp(),
	delta_s(), omega(), timeRes(), timeRes1(), timeRes2(),
	timeRes1Frac(), angAccI1(), angAccI2(), angAccI3(),
	angAccI4(), angAccI5(), angAccI6(), angAccI7(),
	angAccI8(), angAccI9(), angAccI10(), time(), cosTheta(),
	phi(), cosPsi(), q(), tlow(), thigh()
{
	MakePrototypes();
}

//Make the data point and parameter set
void Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave::MakePrototypes()
{
...
//Destructor
Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave::~Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave()
{
}

//Not only set the physics parameters, but indicate that the cache is no longer valid
bool Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave::SetPhysicsParameters( ParameterSet * NewParameterSet )
{
	normalisationCacheValid = false;
	evaluationCacheValid = false;
...
vector<string> Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave::GetDoNotIntegrateList()
{
...
double Bs2JpsiPhi_mistagParameter_withTimeRes_withAverageAngAcc_withsWave::Normalisation(DataPoint * measurement, PhaseSpaceBoundary * boundary)
{
