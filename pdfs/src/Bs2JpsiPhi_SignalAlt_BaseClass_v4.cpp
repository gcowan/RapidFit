...
// Physics parameters
	...
	resolution(), timeIntegralCacheValid(), storeExpL(), storeExpH(), storeExpSin(), storeExpCos()
{
...
//	Copy Constructor
Bs2JpsiPhi_SignalAlt_BaseClass_v4::Bs2JpsiPhi_SignalAlt_BaseClass_v4( const Bs2JpsiPhi_SignalAlt_BaseClass_v4& input )	: BasePDF( (BasePDF) input ),
	...
	storeExpSin(input.storeExpSin), storeExpCos(input.storeExpCos)
{
