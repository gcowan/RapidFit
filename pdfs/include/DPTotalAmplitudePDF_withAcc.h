// $Id: DPTotalAmplitudePDF_withAcc.h,v 1.2 2009/11/13 15:31:51 gcowan Exp $
/** @class DPTotalAmplitudePDF_withAcc DPTotalAmplitudePDF_withAcc.h
 *
...
#ifndef DPTotalAmplitudePDF_withAcc_H
#define DPTotalAmplitudePDF_withAcc_H
...
class DPTotalAmplitudePDF_withAcc : public BasePDF
{
	public:
		DPTotalAmplitudePDF_withAcc( PDFConfigurator* );
		DPTotalAmplitudePDF_withAcc( const DPTotalAmplitudePDF_withAcc & );
		~DPTotalAmplitudePDF_withAcc();
	...
	private:
        ...
        //double d[i_max+1][k_max+1][j_max+1];
        //double e[i_max+1][k_max+1][j_max+1];
};
