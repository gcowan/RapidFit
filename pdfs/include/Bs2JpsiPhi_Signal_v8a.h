// $Id: Bs2JpsiPhi_Signal_v8a.h,v 1.1 2009/12/06  Pete Clarke Exp $
/** @class Bs2JpsiPhi_Signal_v8a
 *
 *  This version startef the update from _v8a_ires by movingdecay time resolution to a contained class.
 *
 *  @author Pete Clarke peter.clarke@ed.ac.uk
 *  @date 2013-06-00
 */

#ifndef Bs2JpsiPhi_Signal_v8a_H
#define Bs2JpsiPhi_Signal_v8a_H
...
{
	public:
		Bs2JpsiPhi_Signal_v8a( PDFConfigurator* );
		~Bs2JpsiPhi_Signal_v8a();
