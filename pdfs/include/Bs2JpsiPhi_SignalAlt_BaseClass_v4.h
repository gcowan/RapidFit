...
class Bs2JpsiPhi_SignalAlt_BaseClass_v4  :  public BasePDF 
{
	...
	protected:
		...
		inline double angleFactorEven(  )   const { return (1.0 + ctrsq()) * Mathematics::Global_Frac()  * 4.0/3.0*TMath::Pi() ; }
	
		//......... for one angle tests ...................
		inline double angleFactorOdd(  )   const { return  strsq() * Mathematics::Global_Frac() * 8.0/3.0*TMath::Pi(); }
