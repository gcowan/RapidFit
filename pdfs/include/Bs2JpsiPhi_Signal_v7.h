// $Id: Bs2JpsiPhi_Signal_v7.h,v 1.1 2009/12/06  Pete Clarke Exp $
/** @class Bs2JpsiPhi_Signal_v7
 *
 *  This version startef the update from _v7_ires by movingdecay time resolution to a contained class.
 *
 *  @author Pete Clarke peter.clarke@ed.ac.uk
 *  @date 2013-06-00
 */

#ifndef Bs2JpsiPhi_Signal_v7_H
#define Bs2JpsiPhi_Signal_v7_H
...
//============================================================================================
class Bs2JpsiPhi_Signal_v7 : public BasePDF
{
	public:
		Bs2JpsiPhi_Signal_v7( PDFConfigurator* );
		~Bs2JpsiPhi_Signal_v7();
