// $Id: Bs2JpsiPhi_mistagParameter.h,v 1.1 2009/11/10 10:35:49 gcowan Exp $
/** @class Bs2JpsiPhi_mistagParameter RaPDF_.h
 *
...
#ifndef Bs2JpsiPhi_mistagParameter_H
#define Bs2JpsiPhi_mistagParameter_H

#include "BasePDF.h"

class Bs2JpsiPhi_mistagParameter : public BasePDF
{
	public:
		Bs2JpsiPhi_mistagParameter();
		~Bs2JpsiPhi_mistagParameter();
