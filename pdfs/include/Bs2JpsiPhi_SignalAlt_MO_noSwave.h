// $Id: Bs2JpsiPhi_SignalAlt_MO_noSwave.h,v 1.1 2009/12/06  Pete Clarke Exp $
/** @class Bs2JpsiPhi_SignalAlt_MO_noSwave 
 *
...
#ifndef Bs2JpsiPhi_SignalAlt_MO_noSwave_H
#define Bs2JpsiPhi_SignalAlt_MO_noSwave_H
...
class Bs2JpsiPhi_SignalAlt_MO_noSwave : public BasePDF,  public Bs2JpsiPhi_SignalAlt_BaseClass
{
	public:
		Bs2JpsiPhi_SignalAlt_MO_noSwave();
		~Bs2JpsiPhi_SignalAlt_MO_noSwave();
