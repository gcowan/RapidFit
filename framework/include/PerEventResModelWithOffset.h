...
class PerEventResModelWithOffset : public IResolutionModel
{
	public:

		PerEventResModelWithOffset( PDFConfigurator* configurator, bool quiet=false ) ;
	...
	private:
		...
		ObservableRef resOffsetName;			// Scale to multiply e-by-e resolution
