...
class StatisticsFunctions
{
	public:
		 ...
		 */
		static double Mean( vector<double> inputList );
		 ...
		 */
		static double Variance( vector<double> inputList );
		 ...
		 */
		static int OptimumBinNumber( vector<double> inputList );
		 ...
		 */
		static double Maximum( vector<double> inputList );
		 ...
		 */
		static double Minimum( vector<double> inputList );
		 ...
		 * @return
		 */
		static vector< vector<double> > DiscreteCombinations( vector<string>* allNames, const PhaseSpaceBoundary* inputPhaseSpace,
		 ...
		 * @return
		 */
		static vector<DataPoint*> DataAverage( IDataSet* inputDataSet, vector< vector<double> > DiscreteCombinations, vector< vector<double> > DiscreteValues,
				vector<string> DiscreteNames, vector<string> ContinuousNames, vector<string>& DataPointDescriptions, vector<double>& DataPointWeights );
		 ...
		 */
		static unsigned int NumberOfCombinations( vector<vector<double> > input, unsigned int index=-1 );
