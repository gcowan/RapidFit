...
j.inputsandbox = ['../unittest/Xdata/goldstandard_unbiased_timecut3.root','../unittest/Xdata/goldstandard_biased_timecut3PELC.root','./RapidFit.C','../unittest/cFit/DataFile_Tagged_cFit_MOMP.xml','../lib/libRapidRun.so']
