...
void runRapidScripts(std::string filename = "theFile.root", std::string treename = "DecayTree", std::string trailer = "_Selected.root"){
  ...
  // make the selection
  std::string selectedFile = ApplySelection(rapidFile,treename,trailer);
