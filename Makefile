...
#		Compiler Flags
CXXFLAGS     = -Wno-reorder -DSVN_REV=$(SVN_REV) -O3 -msse -msse2 -msse3 -m3dnow -g -ansi -fPIC -fmerge-all-constants -funroll-all-loops -D__ROOFIT_NOBANNER -Wconversion -Wextra -Wsign-compare -Wfloat-equal -Wmissing-noreturn -Wall -Wno-non-virtual-dtor
